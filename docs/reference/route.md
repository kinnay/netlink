...
<code>**async def add_neighbor**(family: int, index: int, state: int, flags: int, type: int, attrs: dict[int, Any]) -> None</code><br>
<span class="docs">Adds a neighbor table entry (`RTM_NEWNEIGH`).</span>

<code>**async def remove_neighbor**(family: int, index: int, state: int, flags: int, type: int, attrs: dict[int, Any]) -> None</code><br>
